...
class Codigo(models.Model):
    ...
    id_usuario = models.ForeignKey(User, models.DO_NOTHING)
    referencia = models.CharField(max_length=50, blank=True, null=True)
    idlenguaje = models.ForeignKey('Lenguaje', models.DO_NOTHING, blank=True, null=True)
...
#     pass_field = models.CharField(db_column='pass', max_length=500)  # Field renamed because it was a Python reserved word.
#
#     class Meta:
#         managed = False
#         db_table = 'usuarios'
